...
int main(int argc, char **argv)
{
   ...
   float ros_cam_calibration [4] = { 813, 813, 320, 240 }; // fx, fy, cpX, cpY - out of calibration file
   ...
   /*
   cv::FileStorage fs;
   fs.open("ost.yaml", cv::FileStorage::READ);
   ...
   std::cout << "Name der Kamera: "<< name << "camera matrix: " << camera_matrix_code << std::endl;
     fs.release();
   */
